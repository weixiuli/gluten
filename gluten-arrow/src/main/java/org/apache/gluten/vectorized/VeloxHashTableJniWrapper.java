...
public class VeloxHashTableJniWrapper implements RuntimeAware {
  ...
  public native byte[] buildSerializedHashTable(
      long cSchema,
      byte[][] batches,
      int numKeys,
  ...
  public native long deserialize(byte[] serializedHashTable);

  public native byte[][] hashTableToColumnarBatches(long hashTableHandle, long cSchema);

  public native void close(long hashTableHandle);
}
